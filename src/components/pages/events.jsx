    ...
    <>
      ...
      <section className="container mx-auto px-6 py-16 font-archivo">
        <div className="text-start mb-12">
          <h2 className="text-6xl text-[#292929] dark:text-white mb-4">
            Building a Decentralized Future Together
          </h2>
          <h3 className="text-xl text-[#292929] dark:text-[#B0B0B0] mb-4">
            Hackathon
          </h3>
        </div>
        <div className="bg-[#FAFAFA] dark:bg-black mb-24 p-4">
          <h2 className="text-[#292929] dark:text-white text-2xl mb-2">
                  ...
                  <div key={slideIndex} className="w-full flex-shrink-0">
                    <div className="grid grid-cols-3">
                      {events
                        ...
                        .map((event) => (
                          <div key={event.id} className="p-4 rounded-sm">
                            <img
                              src={event.src}
                              alt={`Event ${event.id}`}
        ...
        <h3 className="text-xl text-[#292929] dark:text-[#B0B0B0] mb-4">Conference</h3>
        <div className="bg-[#FAFAFA] dark:bg-black mb-24 p-2">
          <h2 className="text-[#292929] dark:text-white text-2xl mb-2">
                    ...
                    <div key={slideIndex} className="w-full flex-shrink-0">
                      <div className="grid grid-cols-3">
                        {conferences
                          .slice(slideIndex * 3, slideIndex * 3 + 3)
                          .map((conference) => (
                            <div key={conference.id} className="p-4 rounded-sm">
                              <img
                                src={conference.src}
        ...
        <h3 className="text-3xl text-[#292929] dark:text-white mb-12">Other Events</h3>
        <div className="divide-y divide-gray-200 mb-12">
          {upcomingEvents.map((item) => (
            <div
              key={item.id}
              className="grid grid-cols-3 items-center py-4 hover:bg-gray-50 transition-colors"
            >
              <div className="text-[#292929] dark:text-[#C1C1C1]">{item.name}</div>
              <div className="text-[#5D5D5D] dark:text-[#C1C1C1]">{item.platform}</div>
