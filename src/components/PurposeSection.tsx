	...
	return (
		<div className="container mx-auto px-6 py-16">
			...
			<div className="grid gap-8 md:grid-cols-2">
				<div className="bg-[#FAFAFA] p-6 dark:bg-black">
					<h3 className="mb-4 text-3xl font-medium text-[#292929] dark:text-white">
						Empowerment{" "}
						<span className="bg-[#F7F7F7] p-2 align-super text-sm text-[#6C6C6C]">
							mission
						</span>
					</h3>
					<div className="space-y-4">
						<div>
							<h4 className="mb-2 text-2xl text-[#505050] dark:text-[#E5E4E4]">
								Access to Education
							</h4>
							<p className="w-[497px] text-2xl text-[#757575]">
