...
const Partners = () => {
  ...
  return (
    <section className="container mx-auto px-6 py-16 font-archivo">
      <div className="mb-8">
        <h2 className="text-2xl dark:text-white mb-2">Our Partners</h2>
        <p className="text-gray-600 dark:text-[#5D5D5D] text-lg">
          ...
          >
            {partners.map((partner) => (
              <div key={partner.id} className="w-1/3 flex-shrink-0 px-4">
                <div className="bg-[#FAFAFA] p-8 rounded-sm shadow-sm flex items-center justify-center h-48">
                  <img
                    src={partner.logo}
